...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
     ...
     */
    @Override
    public List<MenuVo> getMenuTree(String userId, Boolean isAdmin) {
     ...
     */
    private MenuVo buildMenuTree(SysMenu parentMenu, List<SysMenu> menus) {
        MenuVo menuVo = new MenuVo();
        BeanUtils.copyProperties(parentMenu, menuVo);
        List<MenuVo> childList = menus.stream()
