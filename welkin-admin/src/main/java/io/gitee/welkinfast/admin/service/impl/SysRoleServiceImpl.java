...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
     ...
     */
    @Override
    public PageResult<SysRole> getUserList(PageRequest<RoleVo> pageRequest) {
        Page<SysRole> iPage = new Page(pageRequest.getCurrent(), pageRequest.getSize());
